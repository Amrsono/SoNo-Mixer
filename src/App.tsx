...
const SAMPLE_BEATS = [
    // Custom Samples
    { id: 'c1', name: 'Oriental Instrumental 1', url: '/src/assets/sample/Untitled Instrumental Collection (1).mp3', genre: 'Oriental' },
    { id: 'c2', name: 'Oriental Instrumental 2', url: '/src/assets/sample/Untitled Instrumental Collection (2).mp3', genre: 'Oriental' },
    { id: 'c3', name: 'Oriental Instrumental 3', url: '/src/assets/sample/Untitled Instrumental Collection (3).mp3', genre: 'Oriental' },
    { id: 'c4', name: 'Oriental Instrumental 4', url: '/src/assets/sample/Untitled Instrumental Collection (4).mp3', genre: 'Oriental' },
    { id: 'c5', name: 'Oriental Instrumental Full', url: '/src/assets/sample/Untitled Instrumental Collection.mp3', genre: 'Oriental' },
    { id: 'c6', name: 'Whiskey in the Wind 1', url: '/src/assets/sample/Whiskey in the Wind (1).mp3', genre: 'Acoustic' },
    { id: 'c7', name: 'Whiskey in the Wind 2', url: '/src/assets/sample/Whiskey in the Wind (2).mp3', genre: 'Acoustic' },
    { id: 'c8', name: 'Whiskey in the Wind 3', url: '/src/assets/sample/Whiskey in the Wind (3).mp3', genre: 'Acoustic' },
    { id: 'c9', name: 'Whiskey in the Wind 4', url: '/src/assets/sample/Whiskey in the Wind (4).mp3', genre: 'Acoustic' },
    { id: 'c10', name: 'Whiskey in the Wind 5', url: '/src/assets/sample/Whiskey in the Wind (5).mp3', genre: 'Acoustic' },
    { id: 'c11', name: 'Whiskey in the Wind Full', url: '/src/assets/sample/Whiskey in the Wind.mp3', genre: 'Acoustic' },
    { id: 'c12', name: 'Whiskey in the Wind2 (1)', url: '/src/assets/sample/Whiskey in the Wind2 (1).mp3', genre: 'Acoustic' },
    { id: 'c13', name: 'Whiskey in the Wind2 (2)', url: '/src/assets/sample/Whiskey in the Wind2 (2).mp3', genre: 'Acoustic' },
    { id: 'c14', name: 'Whiskey in the Wind2 (3)', url: '/src/assets/sample/Whiskey in the Wind2 (3).mp3', genre: 'Acoustic' },
    { id: 'c15', name: 'Whiskey in the Wind2 Full', url: '/src/assets/sample/Whiskey in the Wind2.mp3', genre: 'Acoustic' },
    { id: 'c16', name: 'Whispers of the Sand 1', url: '/src/assets/sample/Whispers 45of the Sand (1).mp3', genre: 'Ethereal' },
    { id: 'c17', name: 'Whispers of the Sand Full', url: '/src/assets/sample/Whispers 45of the Sand.mp3', genre: 'Ethereal' },
    { id: 'c18', name: 'Whispers of the Past', url: '/src/assets/sample/Whispers of the Past.mp3', genre: 'Ethereal' },
    { id: 'c19', name: 'Whispers of the Sand v2', url: '/src/assets/sample/Whispers of78 the Sand.mp3', genre: 'Ethereal' },
    { id: 'c20', name: 'Desert Gravity', url: '/src/assets/sample/trip hop orientalDesert Gravity.mp3', genre: 'Trip Hop' },
    { id: 'c21', name: 'أصوات الظلال 1', url: '/src/assets/sample/أصوات الظلال (1).mp3', genre: 'Ambient' },
    { id: 'c22', name: 'أصوات الظلال كاملة', url: '/src/assets/sample/أصوات الظلال.mp3', genre: 'Ambient' },
    { id: 'c23', name: 'رعب في الشوارع 1', url: '/src/assets/sample/رعب في الشوارع (1).mp3', genre: 'Cinematic' },
    { id: 'c24', name: 'رعب في الشوارع 2', url: '/src/assets/sample/رعب في الشوارع (2).mp3', genre: 'Cinematic' },
    { id: 'c25', name: 'رعب في الشوارع 3', url: '/src/assets/sample/رعب في الشوارع (3).mp3', genre: 'Cinematic' },
    { id: 'c26', name: 'رعب في الشوارع كاملة', url: '/src/assets/sample/رعب في الشوارع.mp3', genre: 'Cinematic' },
];
